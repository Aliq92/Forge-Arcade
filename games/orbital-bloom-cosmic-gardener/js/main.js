...
import { loadSettings, PALETTE, state } from './config.js';
import { Camera } from './camera.js';
import { initRenderer, resize as resizeRenderer } from './renderer.js';
import { initTools } from './tools.js?v=cosmic-gardener-8-fix3';
import { initSimulation, startLoop } from './simulation.js';
import { initUI } from './ui.js?v=cosmic-gardener-8-fix3';
...
function initTitleBackground() {
  ...
  function frame(now) {
    ...
    for (const o of orbiters) {
      ...
      ctx.strokeStyle = 'rgba(244,240,220,0.22)';
      ctx.lineWidth = 0.8;
      ctx.beginPath(); ctx.ellipse(cx, cy, o.radius * 2.3, o.radius * 0.85, 0, 0, Math.PI * 2); ctx.stroke();
