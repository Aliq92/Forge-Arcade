...
SG.Audio = class {
  ...
  denied() { this.tone({ freq: 160, dur: 0.13, type: 'square', gain: 0.14, slideTo: 100 }); }
  unlockRegion() { [392, 523, 659].forEach((f, i) => this.tone({ freq: f, dur: 0.35, type: 'sine', gain: 0.18, delay: i * 0.09 })); }
};
