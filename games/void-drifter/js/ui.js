...
class UIManager {
  constructor() {
    ...
    this.sectorBannerName = id('sectorBannerName');
    this.sectorBannerDesc = id('sectorBannerDesc');
  ...
  setSector(name, desc) {
    ...
    this.sectorBannerName.textContent = name;
    this.sectorBannerDesc.textContent = desc || '';
  ...
  drawMinimap(player, world, sectorInfo, insideIonCloud, beacons, reducedMotion) {
    ...
    const jitter = insideIonCloud ? (reducedMotion ? 1.2 : 4) : 0;
